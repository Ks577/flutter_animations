...
class _SplashScreenState extends State<SplashScreen> with
    SingleTickerProviderStateMixin { //управление временем анимации
  ...
  @override
  void dispose() { //освобождение части памяти, поселедний этап жизненного цикла виджета
    super.dispose();
  }
          ...
          Align(
              ...
              InkWell(
                  onTap: () => Navigator.push(context,
                      PageTransition(type: PageTransitionType.leftToRight,duration:
                      const Duration(seconds:1),  child:  ListScreen(),
                           )),
                  child: AvatarGlow(
                      endRadius: 60.0,
